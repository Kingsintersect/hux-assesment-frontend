...
export function CreateContact() {
    return (
        <Link
            ...
            className="flex h-10 items-center rounded-lg bg-orange-700 px-4 text-sm font-medium text-white transition-colors hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600"
        >
